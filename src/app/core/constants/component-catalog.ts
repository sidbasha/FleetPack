...
export const COMPONENT_CATALOG: ComponentCatalogEntry[] = [
  ...
  { name: 'BaseGanttTimelineComponent', selector: 'base-gantt-timeline', group: 'Base Module · Charts & Timeline', file: 'base/components/base-timeline.components.ts', description: "24h per-row state segments — the detail view a heatmap cell expands into. Rows can carry stacked, mutually-exclusive `lanes` (e.g. a 'System' lane above a 'Tool' lane)." },
